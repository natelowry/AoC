...
var opcode = input5a[index];

while (opcode !== 99) {
    const current = input5a[index];
    ...
    const firstParam = firstParamImmediateMode ? input5a[index + 1] : input5a[input5a[index + 1]];
    const secondParam = secondParamImmediateMode ? input5a[index + 2] : input5a[input5a[index + 2]];
    ...
    if (opcode === 1) {
        ...
        input5a[input5a[index + 3]] = firstParam + secondParam;
        index += 4;
    } else if (opcode === 2) {
        ...
        if (firstParam < secondParam) {
            input5a[input5a[index + 3]] = 1;
        } else {
            input5a[input5a[index + 3]] = 0;
        }
        index += 4;
    } else if (opcode === 8) {
